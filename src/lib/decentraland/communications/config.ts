export type CommsListenerConfig = {
  ...
  port: number
  realm: string
  /** PULSE_DEBUG: log each received Pulse position. Read once here, never in the per-packet hot path. */
  debug: boolean
}
